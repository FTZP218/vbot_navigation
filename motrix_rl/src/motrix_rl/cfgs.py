...
class locomotion:
    ...
    @rlcfg("vbot_locomotion_section011_base")
    @dataclass
    class VBotLocomotionSection011BasePPO(Go1WalkRoughPPO):
        """VBot section011_base locomotion pretrain config."""
    ...
    @rlcfg("MotrixArena_S1_section011_46")
    @rlcfg("vbot_locomotion_section011")
    @dataclass
    class VBotLocomotionSection011PPO(VBotLocomotionSection011BasePPO):
        """VBot section011 locomotion pretrain config."""

    @rlcfg("MotrixArena_S1_section013_46")
    @rlcfg("vbot_locomotion_section013")
    @dataclass
    class VBotLocomotionSection013PPO(VBotLocomotionSection011PPO):
        """VBot section013 locomotion pretrain config."""

    @rlcfg("MotrixArena_S1_section012_46")
    @rlcfg("vbot_locomotion_section012")
    @dataclass
    class VBotLocomotionSection012PPO(VBotLocomotionSection011PPO):
        """VBot section012 locomotion pretrain config."""
...
class navigation:
    ...
    @rlcfg("MotrixArena_S1_section001_46")
    @rlcfg("vbot_navigation_section001")
    @dataclass
    class VBotSection001PPO(PPOCfg):
        # ===== Basic Training Parameters =====
        seed: int = 42  # Random seed
        num_envs: int = 2048  # Number of parallel environments during training
        play_num_envs: int = 16  # Number of parallel environments during evaluation
